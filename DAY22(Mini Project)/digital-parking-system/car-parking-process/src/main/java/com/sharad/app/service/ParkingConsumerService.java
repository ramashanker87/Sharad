...
import com.sharad.app.repo.CarRepo;
import com.sharad.app.repo.ParkingEndRepo;
import com.sharad.app.repo.ParkingStartRepo;
...
public class ParkingConsumerService {
    ...
    @Autowired
    private ParkingStartRepo parkingStartRepository;

    @Autowired
    private ParkingEndRepo parkingEndRepository;
    ...
    public ParkingConsumerService(AmqpTemplate consumerAmqpTemplate, CarRepo carRepository) {
